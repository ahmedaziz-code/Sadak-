...
class Famille
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="RemarqueFamille", mappedBy="famille")
     */
    private $remarqueFs;
     ...
     */
    public function getRemarqueFs(): ArrayCollection
    {
        return $this->remarqueFs;
    }

    /**
     * @param ArrayCollection $remarqueFs
     */
    public function setRemarqueFs(ArrayCollection $remarqueFs): void
    {
        $this->remarqueFs = $remarqueFs;
    }
